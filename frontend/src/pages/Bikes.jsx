...
const BrandLogo = ({ name, logo }) => {
  ...
  const candidates = useMemo(() => {
    return [src, knownSrc].map((x) => String(x || '').trim()).filter(Boolean);
  }, [knownSrc, src]);
  ...
  if (!activeSrc || failed) {
    return (
      <div className="relative grid h-16 w-16 place-items-center overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-[0_18px_50px_-34px_rgba(0,0,0,0.9)] transition duration-300 group-hover:scale-[1.03] group-hover:border-sky-400/40">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(70px_70px_at_50%_35%,rgba(56,189,248,0.22),transparent_62%)]" />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-black/10 via-black/25 to-black/35" />
        <div className="relative text-lg font-black tracking-[0.18em] text-white/90">{initial}</div>
      </div>
    );
  }

  return (
    <div className="relative h-16 w-16 overflow-hidden rounded-2xl border border-white/10 bg-white/90 p-2 shadow-[0_18px_50px_-34px_rgba(0,0,0,0.9)] transition duration-300 group-hover:scale-[1.03] group-hover:border-sky-400/40">
      <img
        src={activeSrc}
        alt={label}
        onError={() => {
...
const BikeCard = ({ bike, typeLabel, t, onCustomize }) => {
  ...
  const rawName = bike?.name || 'Untitled';
  const displayName = (() => {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-zinc-800/80 bg-zinc-950/30 backdrop-blur-xl transition-all duration-300 ease-out hover:-translate-y-1 hover:border-sky-500/40 hover:bg-zinc-950/45 hover:shadow-[0_0_0_1px_rgba(14,165,233,0.25),0_24px_80px_-36px_rgba(14,165,233,0.45)]">
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-zinc-900">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-0 h-14 bg-gradient-to-b from-sky-500/10 to-transparent opacity-0 transition duration-300 group-hover:opacity-100" />
      </div>
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="flex items-center gap-2 transition sm:pointer-events-none sm:opacity-0 sm:group-hover:pointer-events-auto sm:group-hover:opacity-100">
          <button
            ...
            className="inline-flex flex-1 items-center justify-center rounded-lg bg-sky-400 px-3 py-2 text-sm font-medium text-zinc-950 transition hover:bg-sky-300"
          >
            {t('carcard_customize')}
          </button>
          <Link
...
const Bikes = () => {
  ...
  const BrandsStep = () => {
    ...
    return (
      <div className="relative overflow-hidden rounded-[34px] border border-white/10 bg-zinc-950/35 p-8 shadow-[0_40px_120px_-90px_rgba(56,189,248,0.55)] backdrop-blur-2xl sm:p-10">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(900px_420px_at_10%_10%,rgba(56,189,248,0.22),transparent_62%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(820px_480px_at_90%_18%,rgba(34,211,238,0.14),transparent_60%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(900px_520px_at_55%_110%,rgba(168,85,247,0.10),transparent_60%)]" />
          <div className="absolute inset-0 opacity-[0.06] [background-image:linear-gradient(rgba(255,255,255,0.7)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.7)_1px,transparent_1px)] [background-size:26px_26px]" />
          <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-sky-400/60 to-transparent" />
        </div>

        <div className="relative mx-auto max-w-5xl text-center">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/10 bg-black/20 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.22em] text-white/65">
          ...
          <div className="mt-2 text-sm font-semibold text-white/60 sm:text-base">{t('bikes_page_subtitle')}</div>
        </div>
          ...
          {cards.map((item) => {
            ...
            return (
              <button
                ...
                className="group relative flex w-full items-center gap-4 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.035] p-5 text-left shadow-[0_24px_90px_-70px_rgba(0,0,0,0.95)] backdrop-blur-xl transition-all duration-300 ease-out hover:-translate-y-1 hover:border-sky-400/45 hover:bg-white/[0.05] hover:shadow-[0_0_0_1px_rgba(56,189,248,0.25),0_34px_110px_-58px_rgba(56,189,248,0.55)]"
              >
                <div className="pointer-events-none absolute inset-0 opacity-0 transition duration-300 group-hover:opacity-100">
                  <div className="absolute -inset-10 bg-[radial-gradient(420px_240px_at_20%_35%,rgba(56,189,248,0.18),transparent_60%)]" />
                  <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-sky-300/60 to-transparent" />
                </div>

                <BrandLogo name={name} logo={logo} />
                <div className="min-w-0">
                  <div className="truncate text-base font-black tracking-tight text-white">{name}</div>
                  <div className="mt-1 text-[11px] font-semibold text-white/45">{t('landing_select')}</div>
                </div>
                <div className="ml-auto grid h-10 w-10 place-items-center rounded-2xl border border-white/10 bg-black/20 text-white/75 transition group-hover:border-sky-400/40 group-hover:bg-sky-500/10">
        ...
        >
          <input
            ...
            placeholder={t('bikes_search_placeholder')}
              className="w-full rounded-xl border border-zinc-800/80 bg-zinc-950/60 px-4 py-3 text-sm text-zinc-100 outline-none transition focus:border-sky-500/70"
          />
          <button className="rounded-xl bg-sky-400 px-4 py-3 text-sm font-medium text-zinc-950 transition hover:bg-sky-300">
            {t('common_search')}
          </button>
        </form>
              ...
              return (
                <button
                  ...
                  className={`rounded-full border px-3 py-2 text-xs font-medium transition ${
                    active
                      ? 'border-sky-500/60 bg-sky-500/15 text-sky-200 shadow-[0_0_0_1px_rgba(14,165,233,0.12)]'
        ...
        <div className="mt-5">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="w-full rounded-xl border border-zinc-800/80 bg-zinc-950/60 px-3 py-2 text-sm text-zinc-100 outline-none transition focus:border-sky-500/70"
            >
      ...
      <div className="relative z-10 w-full max-w-sm overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 shadow-2xl">
        ...
        <div className="p-5">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <Link
              to={`/login`}
              className="grid place-items-center rounded-lg bg-sky-400 px-4 py-2 text-sm font-medium text-zinc-950 hover:bg-sky-300"
          ...
          {!loading && !error && sorted.length === 0 ? (
            <div className="rounded-2xl border border-zinc-800/80 bg-zinc-950/30 p-6 backdrop-blur-xl">
              ...
              <button
                type="button"
                onClick={clearFilters}
                className="mt-4 rounded-xl bg-sky-400 px-4 py-3 text-sm font-medium text-zinc-950 transition hover:bg-sky-300"
              >
                {t('bikes_clear_filters')}
              </button>
            </div>
