...
const { listCarsAdmin, createCarAdmin, updateCarAdmin, deleteCarAdmin, uploadModelAdmin } = require('../controllers/adminCarsController');
...
router.post('/upload-model', adminRequired, upload.single('file'), uploadModelAdmin);
